...
#: margin is already inside the quote; the exchange charges 2% — the My Betfair Rewards
#: Basic package the founder switched the account to on 2026-07-30 (TE-0044) — because its
#: quote has no margin in it. Derived from the venue registry rather than listed by hand so
#: that adding a venue cannot leave it silently free to bet at.
COMMISSIONS = {v.key: (0.02 if v.kind is Kind.EXCHANGE else 0.0) for v in VENUES}  # TE-0044
